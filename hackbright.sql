...
5	haojing9058	Markov	40
6	haojing9058	Blockly	60
7	psqlmaster	Blockly	45
8	psqlmaster	SQL	100
\.
...
COPY projects (id, title, description, max_grad) FROM stdin;
1	Markov	Tweets generated from Markov chains	50
2	Blockly	pair programming	80
3	Testing	Introduction to unit and integration tests	90
4	Flask	Python library for making web application	40
5	Restaurant Rating	dictionary practice	70
\.
